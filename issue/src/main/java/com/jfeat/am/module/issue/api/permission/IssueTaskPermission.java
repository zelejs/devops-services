...
public class IssueTaskPermission {
    ...
    public static final String ISSUETASK_NEW = "issuetask.new";
    public static final String ISSUETASK_EDIT = "issuetask.edit";
    public static final String ISSUETASK_DELETE = "issuetask.delete";
}
